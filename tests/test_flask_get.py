...
@pytest.mark.parametrize(
    ...
    [
        (
            "/cli/simple-no-params-command",
            200,
            b">Simple-No-Params-Command</",
        ...
        (
            "/cli/command-with-option-and-argument",
            200,
            b">Command-With-Option-And-Argument</",
            [
                "0.0.flag.bool_flag.1.checkbox.--debug",
        ...
        (
            ...
            200,
            b">A-Sub-Group-Command</",
            ["0.0.flag.bool_flag.1.checkbox.--debug"],
        ),
        (
            "/cli/command-with-input-folder",
            200,
            b">Command-With-Input-Folder</",
            [
                "0.0.flag.bool_flag.1.checkbox.--debug",
        ...
        (
            "/cli/command-with-output-folder",
            200,
            b">Command-With-Output-Folder</",
            [
                "0.0.flag.bool_flag.1.checkbox.--debug",
        ...
        (
            "/cli/command-with-flag-without-off-option",
            200,
            b">Command-With-Flag-Without-Off-Option</",
            [
                "0.0.flag.bool_flag.1.checkbox.--debug",
        ...
        (
            "/cli/command-with-variadic-args",
            200,
            b">Command-With-Variadic-Args</",
            [
                "0.0.flag.bool_flag.1.checkbox.--debug",
...
def test_get_command(
    command_path, response_code, expected_msg, expected_form_ids, app, client
):
